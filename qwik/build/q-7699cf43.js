import{d as o,F as r,H as n,g as a}from"./q-71956c83.js";const d=[{text:"Serialization",id:"serialization",level:2}],l={title:"Storing State",meta:[],styles:[],links:[],frontmatter:{contributors:["adamdbradley","manucorporat","mhevery"]}},h={title:"Storing State",contributors:["adamdbradley","manucorporat","mhevery"]};function i(t){const e=Object.assign({p:"p",ol:"ol",li:"li",code:"code",blockquote:"blockquote",strong:"strong",a:"a",h2:"h2",span:"span",em:"em"},t.components);return n(a,{children:[n(e.p,{children:"Applications need to store state to be useful, otherwise they're just static pages."}),`
